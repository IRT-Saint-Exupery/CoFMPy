...
As an end user, we suggest to start with the main object in CoFmuPy: the
[Coordinator](./coordinator.md). After creating your JSON configuration file, the
_Coordinator_ is the only CoFmuPy object to start with: you can load the configuration
...
provided in CoFmuPy: inheritance, abstract methods and members, etc. For more details,
